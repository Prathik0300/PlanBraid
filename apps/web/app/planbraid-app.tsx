...
function ProviderStack({ providers }: { providers: string[] }) {
  const names = providers.map((provider) => providerLabel[provider] ?? provider).join(", ");
